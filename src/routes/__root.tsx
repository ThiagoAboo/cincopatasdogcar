...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cinco Patas Dog Car & Walker | Transporte e Passeios Pet" },
      { name: "description", content: "Táxi Dog e Dog Walker profissional em Alcântara, São Gonçalo. Atendemos Niterói, Maricá e Itaboraí com segurança, conforto e preços justos." },
      { name: "author", content: "Táxi Dog Alcântara" },
      { property: "og:title", content: "Cinco Patas Dog Car & Walker | Transporte e Passeios Pet" },
      { property: "og:description", content: "Táxi Dog e Dog Walker profissional em Alcântara, São Gonçalo. Atendemos Niterói, Maricá e Itaboraí com segurança, conforto e preços justos." },
